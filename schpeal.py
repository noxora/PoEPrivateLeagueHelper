...
If you are able to **contribute 10 points** to the crowdfund, please follow these steps to skip the line
...
unknown_schpeal = "Hello! I didn't see a command in your message, if you would like instructions, please respond with ```!intro```"
